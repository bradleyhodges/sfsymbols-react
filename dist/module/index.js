...
const SFIconBase = React.forwardRef(({ icon, color, className, weight = null, fillOpacity = null, size = null, title, "aria-label": ariaLabel, ...rest }, ref) => {
    ...
    const paths = React.useMemo(() => svgPathData?.map((path, idx) => (_jsx("path", { d: path.d, fill: color ?? path.fill ?? "currentColor", fillOpacity: effectiveFillOpacity ?? path.fillOpacity }, `${idx}-${path.d}`))), [svgPathData, color, effectiveFillOpacity]);
    // Render the icon
    return (_jsxs("svg", { ref: ref, width: computedSize, height: computedSize, focusable: false, xmlns: "http://www.w3.org/2000/svg", xmlnsXlink: "http://www.w3.org/1999/xlink", viewBox: computedViewBox, preserveAspectRatio: "xMidYMid meet", className: React.useMemo(() => cn(BASE_CLASS_NAME, className), [className]), ...weightProps, ...ariaProps, ...rest, children: [title ? _jsx("title", { id: titleId, children: title }) : undefined, paths] }));
});
 ...
 */
export const SFIcon = React.memo(SFIconBase);
